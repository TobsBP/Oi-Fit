      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-6 md:p-12">
        ...
        <div className="max-w-5xl w-full">
          ...
          <div className="text-center mb-12">
            <div className="inline-block bg-[#3C5F2D] text-white px-8 py-3 rounded-full font-bold text-xl mb-6 shadow-xl">
              Oi-Fit
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="md:col-span-2 bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl p-8 md:p-10 transform hover:scale-[1.02] transition-all duration-300">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#3C5F2D] mb-3">Nossa Missão</h2>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Bem-vindo à <span className="font-bold text-[#3C5F2D]">Oi-Fit</span>! Somos uma marca dedicada a fornecer roupas de alta qualidade para entusiastas de fitness e estilo de vida ativo. Nossa missão é inspirar e capacitar nossos clientes a alcançarem seus objetivos de saúde e bem-estar, oferecendo produtos que combinam conforto, funcionalidade e estilo.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-xl p-8 transform hover:scale-[1.02] transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-[#3C5F2D] mb-3">Entregamos</h3>
              <p className="text-gray-700 leading-relaxed">
                Ouro Fino, Inconfidentes, Borda da Mata, Pouso Alegre, Jacutinga e região.
              </p>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-xl p-8 transform hover:scale-[1.02] transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-[#3C5F2D] mb-3">Nosso Compromisso</h3>
              <p className="text-gray-700 leading-relaxed">
                Obrigado por escolher a Oi-Fit como sua marca de confiança. Estamos ansiosos para fazer parte da sua jornada de fitness e estilo de vida saudável!
              </p>
            </div>
          </div>
          ...
          <div className="bg-linear-to-r from-[#3C5F2D] to-[#4a7338] rounded-3xl shadow-2xl p-8 md:p-12 text-center transform hover:scale-[1.02] transition-all duration-300">
            ...
            <p className="text-2xl md:text-3xl font-bold text-white italic leading-relaxed">
              Criado com propósito, pensado para o seu treino — vista o movimento.
            </p>
          </div>

          {/* Estatísticas ou valores */}
          <div className="grid grid-cols-3 gap-4 mt-12">
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300">
              <p className="text-3xl font-bold text-[#3C5F2D] mb-2">100+</p>
              <p className="text-sm text-gray-600 font-medium">Produtos</p>
            </div>
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300">
              <p className="text-3xl font-bold text-[#3C5F2D] mb-2">5★</p>
              <p className="text-sm text-gray-600 font-medium">Avaliação</p>
            </div>
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300">
              <p className="text-3xl font-bold text-[#3C5F2D] mb-2">24/7</p>
