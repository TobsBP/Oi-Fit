...
function ProductsContent() {
  ...
  const categories = ['all', 'Top', 'Calça', 'Short', 'Conjunto', 'Macacão', 'Macaquinho'];
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[#a5c893] to-[#8fb377] text-black">
      <div className="max-w-7xl mx-auto p-6 md:p-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-[#3C5F2D] mb-2">Produtos</h1>
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          ...
          <div className="relative">
            ...
            >
              ...
              Filtrar
              {filterCategory !== 'all' && (
                <span className="ml-1 px-2 py-0.5 bg-[#3C5F2D] text-white text-xs rounded-full">1</span>
              )}
            </button>
          ...
          {filterCategory !== 'all' && (
            <div className="flex items-center gap-2 px-4 py-3 bg-[#3C5F2D] text-white rounded-2xl">
              <span className="text-sm font-medium">
                Filtro: {filterCategory.charAt(0).toUpperCase() + filterCategory.slice(1)}
              </span>
              <button
